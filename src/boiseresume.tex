...
\objective{A highly motivated systems engineer with an \tech{active TS/SCI}
  ...
  diverse set of skills to use in a renowned
  company.} %such as High Point Aerotechnologies.}
